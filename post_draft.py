#!/usr/bin/env python3
"""
Post a completed draft to broadwaytreatmentcenter.com via the WordPress REST API.
...
API_ENDPOINT = os.environ.get("WP_API_ENDPOINT",
                              "https://broadwaytreatmentcenter.com/wp-json/wp/v2/posts")
...
def main():
    ...
    if not TITLE or not SLUG or not CONTENT:
        ...
        print("  Complete the /url → /bk-wp → /schema workflow first.")
        sys.exit(1)
